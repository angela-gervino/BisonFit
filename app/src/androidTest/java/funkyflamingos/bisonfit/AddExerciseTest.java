...
public class AddExerciseTest {
    ...
    public void addExerciseTest() {
        ...
        // check if workout overview is empty for new workout
        onView(withId(R.id.exercise_item_layout)).check(doesNotExist());
        ...
        // check for exercise on workout overview
        onView(withId(R.id.exercise_item_layout)).check(matches(isDisplayed()));
    }
}
